...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      {
        staticClass:
          "border border-grey-200 rounded-lg flex items-center justify-center mb-8"
      },
      [
        _c("div", {
          ref: "lottie",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "mb-10 text-grey-900 leading-normal" }, [
      _vm._v("\n        This spinner uses AirBnb's\n        "),
      _c(
        "a",
        {
          staticClass: "text-as-blue font-bold",
